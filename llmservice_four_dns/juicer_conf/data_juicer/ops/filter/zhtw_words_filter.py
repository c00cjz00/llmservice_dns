...
class ZHTWWordsFilter(Filter):
    ...
    def __init__(self,
        ...
        self.FLAGGED_WORDS = {'zh': json.load(open('assets/common_char_tw.json')), 
                              'all': json.load(open('assets/common_char_tw.json'))}
